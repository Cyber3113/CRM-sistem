  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    editBtn.addEventListener("click", function () {
      inputs.forEach(input => input.disabled = false); // Inputlarni faollashtirish
      saveBtn.disabled = false; // Saqlash tugmasini faollashtirish
    });
  
    saveBtn.addEventListener("click", function () {
      inputs.forEach(input => input.disabled = true); // Inputlarni bloklash
      saveBtn.disabled = true; // Saqlash tugmasini qayta o‘chirish
      ...
      displayJob.textContent = document.getElementById("job").value;
    });
  });
